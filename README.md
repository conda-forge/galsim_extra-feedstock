...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/galsim_extra-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12482&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/galsim_extra-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `galsim_extra` can be installed with:

```
conda install galsim_extra
```

It is possible to list all of the versions of `galsim_extra` available on your platform with:
